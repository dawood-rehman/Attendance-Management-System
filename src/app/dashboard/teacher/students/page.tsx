    ...
    <div className="space-y-6 animate-fade-up">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-white/40 text-sm mt-0.5">{students.length} students enrolled</p>
        </div>
      ...
      <Card className="p-0 overflow-hidden">
        {loading ? (
          ...
          <EmptyState
            ...
            action={<Button onClick={openAdd} size="sm"><Plus size={14} /> Add First Student</Button>}
          />
        ) : (
